...
const getTrack = (caseTrack) => {
  switch (caseTrack) {
    case "TRACK 1":
      //  Ya koi number dal sakte (6 mahine mai nipatana hai yeh case)
      return "Highly severe";

    case "TRACK 2":
      //  (12 mahine mai nipatana hai yeh case)
      return "Moderate";
    case "TRACK 3":
      //  (24 mahine mai nipatana hai yeh case)
      return "Low ";
  }
};
