...
const CaseFiling = () => {
  ...
  const [CNRNum, setCNRNum] = useState("");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      let data = {
        ...
        filingTime: timeOfFiling,
        prayer: prayer,
        reliefClaimed: reliefClaimed,
        causeOfAction: causeOfAction,
        act1: act1,
        actSection1: actSection1,
        causeOfActionDate: dateOfCauseOfAction,
      };
      ...
      console.log(response?.data?.filingNumber);
      console.log(response?.data?.cnrNumber);
      //console.log(JSON.stringify(response))

      setFilingNum(response?.data);
        ...
        <form className="w-[1235px] pt-8">
          <div className="flex flex-col space-y-4">
            ...
            <div className="flex space-x-12 justify-between px-10 items-center text-center">
              ...
              <div>
                <div className="flex">
                  <p>Filing Number : {filingNum.filingNumber}</p>
                  <p></p>
                </div>
                <div className="flex">
                  <p>CNR Number :{filingNum.cnrNumber}</p>
                  <p></p>
                </div>
              </div>
              ...
              <div className="flex flex-col w-80">
                ...
                >
                  {ipcSection.map((caseTypeItem) => (
                    <option key={caseTypeItem.id} value={caseTypeItem.name}>
                      {caseTypeItem.name}
                    </option>
                  ))}
                </select>
